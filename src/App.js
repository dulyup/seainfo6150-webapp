        ...
        <article>
          ...
          <section>
            <h4>The history of the Statue of Liberty</h4>
              <p> Not only is the Statue of Liberty the symbol of New York City, she is also a <abbr title="United Nations Educational, Scientific and Cultural Organization">UNESCO</abbr> World Heritage site under the designation of <i>Outstanding Universal Value</i>.</p>
          ...
          <section>
              ...
              <ul>
                  ...
                  <li>
                      <p>
                          Height of the Statue from her heel to the top of her head is <strong>111 feet, 6 inches</strong>
                      </p>
                  </li>
                  <li>
                      <p>
                  ...
                  <li>
                      <p>
                          Total weight of the Statue of Liberty is <strong>225 tons</strong> (or <strong>450,000 pounds</strong>)
                      </p>
                  </li>
              </ul>
          </section>
